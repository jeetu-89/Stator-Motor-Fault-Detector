...
# Load the data and st.session_state.uploaded_file25 is not None and st.session_state.uploaded_file50 is not None and st.session_state.uploaded_file75 is not None
    if st.session_state.uploaded_file0 is None:
            ...
            state.df0 = pd.read_csv('https://raw.githubusercontent.com/jeetu-89/Stator-Motor-Fault-Detector/refs/heads/main/Normal.csv')
            state.df25 = pd.read_csv('https://raw.githubusercontent.com/jeetu-89/Stator-Motor-Fault-Detector/refs/heads/main/PP_25.csv')
            state.df50 = pd.read_csv('https://raw.githubusercontent.com/jeetu-89/Stator-Motor-Fault-Detector/refs/heads/main/PP_50.csv')
            state.df75 = pd.read_csv('https://raw.githubusercontent.com/jeetu-89/Stator-Motor-Fault-Detector/refs/heads/main/PP_75.csv')
            # st.session_state.df25 = pd.read_csv(st.session_state.uploaded_file25)
            # st.session_state.df50 = pd.read_csv(st.session_state.uploaded_file50)
            # st.session_state.df75 = pd.read_csv(st.session_state.uploaded_file75)
